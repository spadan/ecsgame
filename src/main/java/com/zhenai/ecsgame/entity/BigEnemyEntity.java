 ...
 * @Description:机器人
 */
public class BigEnemyEntity extends AbstractEntity {

    private static String bigEnemyImageName = "big_enemy";

    public BigEnemyEntity() {
        super();
        ...
        ShapeComponent shape = new ShapeComponent(this, Constant.ENEMY_WIDTH, Constant.ENEMY_HEIGHT, bigEnemyImageName);
